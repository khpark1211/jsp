...
function add_cart() {
	if(${login=='ok'}){
		location.href="/MyController?cmd=addcart&idx=${vo.idx}&id=${mvo.id}";
	}else{
		alert("로그인하세요");
...
function view_cart() {
	if(${login=='ok'}){
		location.href="/MyController?cmd=viewcart&id=${mvo.id}";
	}else{
		alert("로그인하세요");
		location.href="/MyController?cmd=login";
	}
	...
	<table>
		...
		<tr>
			<td colspan="2" align="center">
				<img src="images/${vo.p_image_l}" width="450px"></td>
		</tr>
		<tr>
			<td colspan="2" align="center">
