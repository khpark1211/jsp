...
<script type="text/javascript">
	...
	function update_go(f) {
		f.action="/MyController?cmd=update_go";
		f.submit();
	}
	function delete_go(f) {
		f.action="/MyController?cmd=delete_go";
		f.submit();
	}
</script>
</head>
			...
			<tr>
				...
				<td>
					<c:choose>
						...
						<c:otherwise>
							<img  src="<c:url value='/upload/${vo.file_name}'/>" width="150px"><br>
							<a href="view/download.jsp?file_name=${vo.file_name}&path=upload"> ${vo.file_name}</a>
						</c:otherwise>
					</c:choose>
				</td>
			</tr>
